...
class NotificationListener : NotificationListenerService() {
    ...
    private fun updateNotifications() {
        val prefs = applicationContext.getSharedPreferences("LauncherosPrefs", Context.MODE_PRIVATE)
    ...
    private fun updateUnreadSmsCount() {
        ...
        try {
            ...
            // Check if there are any unread messages in the inbox
            val cursor = contentResolver.query(
            ...
            _unreadSmsCount.value = totalCount
            Log.d(TAG, "updateUnreadSmsCount: Found ${_unreadSmsCount.value} unread messages")
